package com.raquibul.quickstartall.jms.receiver.config;
 ...
 */
@Configuration
public class WeatherReceiverConfig {
	...
	@Bean
	public JmsListenerContainerFactory<?> weatherReceiverFactory(ConnectionFactory connectionFactory,
